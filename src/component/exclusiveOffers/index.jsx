...
import { exclusiveOffers, icons } from '../../utils'
...
const ExclusiveOffers = () => {
  return (
    ...
    >
      ...
      <div
        className='grid grid-cols-1 md:grid-cols2 lg:grid-cols-3 gap-6 mt-12'
      >
        {exclusiveOffers?.map((item) => {
            return (
                ...
                >
                    ...
                    {/*  */}
                    <button
                      className='flex item-center gap-2 font-medium cursor-pointer mt-4 mb-5'
                    >
                        View offers
                        <img
