...
const Hero = () => {
  return (
    ...
    >
      <p
        className='bg-[49B9FF]/50 px-3.5 py-1 rounded-full mt-20'
      > 
      ...
      >
        ...
        and resorts. Immerse yourself in breathtaking views, indulge in luxurious amenities,
        and create unforgettable memories with our exceptional hospitality.
      </p>
    </div>
  )
}
